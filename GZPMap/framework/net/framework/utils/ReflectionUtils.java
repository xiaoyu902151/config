 ...
 * All Rights Reserved. 
 * FileName：com.bxsurvey.util.ReflectionUtils.java 
 * Created On: 2014-12-17 下午2:50:28
 * Description: 前台传后台数据转换格式化
 * @author ldw 
 * @version 1.0
 ***********************************************
 */
public class ReflectionUtils extends org.springside.modules.utils.reflection.ReflectionUtils {
...
//					result = booleanValue(value) ? Boolean.TRUE : Boolean.FALSE;
					result = (value != null && value.toString().equals("true")) ? Boolean.TRUE : Boolean.FALSE;
				...
				if (toType == Date.class)
					result = DateUtils.toDate(stringValue(value), DateUtils.DEFAULT_FORMAT);
					if(result == null){
						result = DateUtils.toDate(stringValue(value), DateUtils.SIMPLE_DEFAULT_FORMAT);
					}
