...
<script type="text/javascript">
	function btnClick(){
			...
			if(!isValid) return;
			parent.addData("jDialogFrame","organForm","${pageContext.request.contextPath}/sysParams.do?save");
		};
	...
	<div id="organDialog">
		<div class="container">
			<form id="organForm" method="post" class="form-horizontal" enctype="multipart/form-data">
				<input type="text" style="display:none" class="form-control" name="paramsType" id="paramsType" value="${paramsType}"/>
				<input type="text" style="display:none" class="form-control" name="pid" id="pid" value="${pid}"/>
				...
				<div class="form-group" style="margin-bottom: 5px;text-align:right;">
					...
					<div class="col-xs-8">
						<input type="text" class="form-control" name="paramsValue" id="paramsValue" />
					</div>
				</div>
				<div class="form-group" style="margin-bottom: 5px;text-align:right;">
					<label class="col-xs-3 control-label">备注</label>
					<div class="col-xs-8">
						<input type="text" class="form-control" name="paramsBz" id="paramsBz" />
					</div>
				</div>
				<div class="form-group" style="margin-bottom: 5px; text-align:right;">
					<label class="col-xs-3 control-label">排序<span>*</span></label>
					<div class="col-xs-8">
						<input type="text" class="form-control" name="paramsIndex" id="paramsIndex" />
					</div>
				</div>
			</form>
			<div class="modal-footer Ptfixed">
				<div>
					<button onclick="btnClick()" class=" btn btn-default" name="save"
						value="save">
