...
<head>
	...
	function initTree(){
		...
		$.ajax({
			type:'POST',
			cache:false,
			url:"${pageContext.request.contextPath}/admin/role.do?getAllTree",
			data:param,
			dataType:'json',
			success:function(r){
				if(r.success){
		...
		function btnClick(){
			...
			parent.addRoleData("jDialogFrame","organForm","${pageContext.request.contextPath}/admin/role.do?save",data);
		};
    ...
    <div id="organDialog" class="col-sm-8 col-sm-offset-2"> 
 	   	<div class="container">
 	   		...
 	   		<form id="organForm" method="post" class="form-horizontal" action="target.php">
		   		<input type="hidden" class="form-control" name="roleValidity" value="true"   />
				...
				<div class="form-group">
						...
						<div class="col-xs-4">
							<input type="text" class="form-control" name="roleBz" />
						</div>
				</div>
