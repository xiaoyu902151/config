...
<body style="overflow:hidden;">
	<div class="top_001">
        ...
        <span style="height: 35px; width: 350px;">当前位置：后台管理&nbsp;>&nbsp;<label >资源管理</label></span>
    </div>
    ...
    <div id="queryPanel">
    	<div class="form form-inline" role="form">
    		<div class="form-group" style="margin:10px 10px;">
		        ...
		        <input class="form-control" id="moduleName" type="text" placeholder="资源名称" >
	      	</div>
...
<script>
    ...
    $(function () {
			...
			datagrid = datagrid.bootstrapTable({
                url: "${pageContext.request.contextPath}/admin/module.do?searchGrid",//数据源
       ...
       function infoFormatter(value, row, index)
        ...
        function add()
		{
		        objDialog = jDialog.iframe("${pageContext.request.contextPath}/admin/module.do?addView",{	                title: '新增资源',
		                width: 700,
		                height:400,
		    ...
		    if(selRows.length > 0) {
		    	var dialog = jDialog.confirm("您要删除当前所选项目？",{
					handler : function(button,dialog) {
						...
						$.ajax({
							url : "${pageContext.request.contextPath}/admin/module.do?delete",
							data : {ids : ids.join(',')},
							cache : false,
							dataType : "json",
		...
		function modify()
		{
			...
			if (selRows.length != 1 && selRows.length != 0) {
				...
				//弹出编辑详情框
				objDialog =  jDialog.iframe("${pageContext.request.contextPath}/admin/module.do?updateView&moduleId="+selRows[0].moduleId,{
					title : '编辑',
					width : 700,
					height : 400,
					iframeId : "jDialogFrame"///对话框iframe的ID
