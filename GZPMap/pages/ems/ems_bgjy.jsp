                    ...
                    <div class="sdlf">
                     ...
                     <div class="sdrt">
	                    	<div class="btn btn-info cursp" style="background:#87d2ef;">
	                            ...
	                            <span style=" margin-left: 5px; padding-right:163px;">报告建议</span>
							</div>
	                        <ul class="nav nav-sidebar nav-padding" style=" margin-left:0px;">
							<li class="active">
								<a href="#">
									<img src="/GZPMap/content/images/ems/zb.png" >
									<span>周边分析</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/GZPMap/content/images/ems/ssjk.png" >
									<span>实时监控</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/GZPMap/content/images/ems/ljjs.png">
									<span>最优路径计算</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/GZPMap/content/images/ems/ssqk.png" width="20">
									<span>实时情况（扩展）</span>
								</a>
							</li>
							<li>
								<a href="bgjy.html">
									<img src="/GZPMap/content/images/ems/bgjy.png">
									<span>报告建议</span>
								</a>
							</li>
						</ul>
