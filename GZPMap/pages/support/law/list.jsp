...
<body style="overflow:hidden;">
	 <div class="top_001">
        ...
        <span style="height: 35px; width: 350px;">当前位置：应急预案&nbsp;>&nbsp;<label>法律法规库</label></span>
    </div>
    ...
    <div id="queryPanel">
      <div class="form form-inline">
    	<div class="form-group" style="margin:10px 10px;">
	        <label class="control-label" >法律名称： </label>
	        <input class="form-control" id="lawName" type="text" placeholder="法律名称" >
       	</div>
       	<div class="form-group" style="margin:10px 10px;">
	        <label class="control-label" >类型： </label>
	        <dict:select defaultValue="" value="" name="type" id="type" dictName="LAW_TYPE" cssClass="form-control"/>
	    </div>
...
<script>
    ...
    $(function () {
			...
			datagrid = datagrid.bootstrapTable({
                url: "${pageContext.request.contextPath}/support/law.do?searchGrid",//数据源
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter:function(value,row,index){
                            var html = "<button type='button' onclick='downLoadFile(\""+value+"\")' class=' btn ' name='reset'><i class='glyphicon glyphicon glyphicon-download-alt'></i>下载</button>";
                            return html;
                        }
        ...
        function downLoadFile(value){
            window.open("${pageContext.request.contextPath}/lawFile.do?downloadFile&path="+value);  
		};
       ...
       function infoFormatter(value, row, index)
        ...
        function add()
		{
		        objDialog = jDialog.iframe("${pageContext.request.contextPath}/support/law.do?addLaw",{	                title: '新增法律法规',
		                width: 650,
		                height:400,
		    ...
		    if(selRows.length > 0) {
		    	var dialog = jDialog.confirm("您要删除当前所选项目？",{
					handler : function(button,dialog) {
						...
						$.ajax({
							url : "${pageContext.request.contextPath}/support/law.do?delete",
							data : {ids : ids.join(',')},
							cache : false,
							dataType : "json",
		...
		function modify()
		{
			...
			if (selRows.length != 1 && selRows.length != 0) {
				...
				//弹出编辑详情框
				objDialog =  jDialog.iframe("${pageContext.request.contextPath}/support/law.do?updateView&id="+selRows[0][idName],{
					title : '修改',
					width : 700,
					height : 450,
					iframeId : "jDialogFrame"///对话框iframe的ID
