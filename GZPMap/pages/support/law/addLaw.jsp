...
<head>
	...
	<script type="text/javascript">
		...
		function btnClick(){
			...
			if(!isValid) return;
			parent.addData("jDialogFrame","organForm","${pageContext.request.contextPath}/support/law.do?save&fj="+fj);
		};
		...
		function deleteRow(index){
		    var row = fileRows[index];addFile
		    if(row.id){
		    	delRows.push(row);
 	   	...
 	   	<div class="container" style="margin-top:10px;">
				...
				<input type="hidden" name="id" />
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="text" class="form-control" name="lawName" id="lawName"  />
						</div>
				    </div>
				    <div class="form-group">
						<label style="padding-left: 44px" class="col-xs-2 control-label">类型</label>
						<div class="col-xs-10">
							<dict:select defaultValue="" value="" name="sysParams.paramsId" id="type" dictName="LAW_TYPE" cssClass="form-control"/>
						</div>
				    </div>		
				    <div class="form-group">
						<label style="padding-left: 44px" class="col-xs-2 control-label">描述</label>
						<div class="col-xs-10">
						     <textarea class="form-control" name="descrition"  id="descrition" rows="4" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
						</div>
				    </div>
				    <div class="form-group">
				   		<label style="padding-left: 44px" class="col-xs-2 control-label">附件</label>
				   		<div class="col-xs-8" style="padding-right:0px;">
								<input  type="text" class="form-control" name="fj" id="fj" disabled="disabled"/>
						</div>
						<div class="col-xs-2" style="padding-left:0px;">
						  ...
						  <!--   <button type="button"  data-toggle="modal" data-target="#mymodal-data" class="btn btn-default" style="margin-left: 0px;" value="查看" id="eventBtn" onclick="addFile()">查看</button> -->
						</div>
	                 </div>	
			</form> 
