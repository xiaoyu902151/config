...
<head>
	...
	<script type="text/javascript">
     ...
     function loadData() {
            ...
            $.fn.zTree.init($("#treePeople"), peopleSetting, zPeopleNodes);
		...
		function btnClick(){
			...
			debugger;
			parent.addData("jDialogFrame","organForm","${pageContext.request.contextPath}/support/plan.do?save",$.toJSON(fileRows),$.toJSON(peopleNodes[0].children),$.toJSON(standNodes[0].children),$.toJSON(plotNodes[0].children));
		};
				...
				<div class="tab-content">
					<div class="tab-pane active" id="promation">	
						<div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<dict:select defaultValue="" value="" name="planType" id="planType" dictName="PLAN_TYPE" cssClass="form-control"/>
							</div>
					    ...
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="versionNumber" id="versionNumber"  />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">发布版本号<span>*</span></label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="docReleaseNumber" id="docReleaseNumber" />
							</div>
							<label class="col-xs-2 control-label">预案级别<span>*</span></label>
							<div class="col-xs-4">
								<dict:select defaultValue="" value="" name="planLevel" id="planLevel" dictName="PLAN_LEVEL" cssClass="form-control"/>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
					    ...
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
									<input type="text" class="form-control" name="expiryDate" id="expiryDate"  style="cursor:pointer; "/>
							</div>
							<label class="col-xs-2 control-label">备案时间<span>*</span></label>
							<div class="col-xs-4">
									<input type="text" class="form-control" name="filingTime" id="filingTime"  style="cursor:pointer; "/>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">发布时间<span>*</span></label>
							<div class="col-xs-4">
									<input type="text" class="form-control" name="docReleaseDate" id="docReleaseDate" style="cursor:pointer; "/>
							</div>
					    ...
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-9" style="padding-right:0px;">
								...
								<input type="hidden"  name="eventType" id="eventType"  /></label>
							</div>
					    ...
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-10">
								<textarea type="text" class="form-control" name="scope" id="scope" rows="3" data-fv-stringlength data-fv-stringlength-max="500"></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">发放范围</label>
							<div class="col-xs-10">
								<textarea type="text" class="form-control" name="range" id="range" rows="3" data-fv-stringlength data-fv-stringlength-max="500"></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">预案描述</label>
							<div class="col-xs-10">
								<textarea type="text" class="form-control" name="remark" id="remark" rows="3" data-fv-stringlength data-fv-stringlength-max="500"></textarea>
							</div>
					    </div>												
					</div>
