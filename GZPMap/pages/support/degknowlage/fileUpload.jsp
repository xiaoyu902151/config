...
<script type="text/javascript">
	function uploadFile() {
		parent.uploadFile("jDialogFrame","organForm","${pageContext.request.contextPath}/file.do?uploadFile");
	}
</script>
</head>
<body>
		...
		<div class="container" style="margin-top:10px;">
			<form id="organForm" method="post" class="form-horizontal" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" style="display:none" class="form-control" name="remotePath" id="remotePath" value="/GZPMap/degknowlage" />
				</div>
			</form>
