...
<head>
	...
	<script type="text/javascript">
		...
		function btnClick(){
			...
			if(!isValid) return;
			parent.addData("jDialogFrame","organForm","${pageContext.request.contextPath}/support/degKnowlage.do?save",$.toJSON(fileRows));
		};
				...
				<div class="tab-content">
					<div class="tab-pane active" id="message">	
						<div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="chName" id="chName"  />
							</div>
							<label class="col-xs-2 control-label">危险货物编号<span>*</span></label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="hwbh" id="hwbh" />
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="unbh" id="unbh" />
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">分子式</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="fzs" id="fzs"  />
							</div>
							<label class="col-xs-2 control-label">分子量</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="fzl" id="fzl" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="wgyxz" id="wgyxz" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="xdmd" id="xdmd" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">沸点（℃）</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="fd" id="fd"  />
							</div>
							<label class="col-xs-2 control-label">饱和蒸气压</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="bhzqy" id="bhzqy" />
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">溶解性</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="rjx" id="rjx"  />
							</div>
							<label class="col-xs-2 control-label">侵入途径</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="qrtj" id="qrtj" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">毒性</label>
							<div class="col-xs-10">
								<textarea class="form-control" name="dx"  id="dx" rows="3" data-fv-stringlength data-fv-stringlength-max="500" data-fv-stringlength data-fv-stringlength-message="长度不能超过500个文字"></textarea>
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">健康危害</label>
							<div class="col-xs-10">
							    <textarea class="form-control" name="jkwh"  id="jkwh" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">急救方法</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="jjff"  id="jjff" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>	
					</div>
					 <div class="tab-pane" id="danger">
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<dict:select defaultValue="" value="" name="rsx" id="rsx" dictName="RSX" cssClass="form-control"/>
							</div>
							<label class="col-xs-2 control-label">燃烧分解物</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="rsfjw" id="rsfjw"  />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" name="bzsx" id="bzsx" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">引燃温度(℃)</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="yrwd" id="yrwd"  />
							</div>
							<label class="col-xs-2 control-label">爆炸下限(v%)</label>
							<div class="col-xs-4">
								<input type="text" class="form-control" name="bzxx" id="bzxx" />
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">危险特性</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="wxtx"  id="wxtx" rows="5" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>	
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">储运条件</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="cytj"  id="cytj" rows="5" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">泄漏处理</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="xlcl"  id="xlcl" rows="6" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					</div>
					<div class="tab-pane" id="way">
						<div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-10">
							     <textarea class="form-control" name="gtfh"  id="gtfh" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">操作处理方法</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="czclff"  id="czclff" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					      <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">运输注意事项</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="yszysx"  id="yszysx" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">储存注意事项</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="cczysx"  id="cczysx" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">泄漏防护</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="xlfh"  id="xlfh" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">火灾防护</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="hzfh"  id="hzfh" rows="3" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					</div>
					<div class="tab-pane" id="intervention">
						<div class="form-group" style="margin-bottom: 5px;">
							...
							<div class="col-xs-10">
							     <textarea class="form-control" name="mhcs"  id="mhcs" rows="11" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					    <div class="form-group" style="margin-bottom: 5px;">
							<label class="col-xs-2 control-label">急救措施</label>
							<div class="col-xs-10">
							     <textarea class="form-control" name="jjcs"  id="jjcs" rows="11" data-fv-stringlength data-fv-stringlength-max="500" ></textarea>
							</div>
					    </div>
					</div>
