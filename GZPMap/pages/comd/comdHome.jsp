...
<%--    <link href="${pageContext.request.contextPath}/content/css/ems/ems-resources.css" rel="stylesheet" type="text/css" />      --%>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/pages/comd/comdHome.js"></script> 
  ...
  <body id="indexLayout"  style="width: 100% ;height: 100% ;overflow: hidden;border: 0px;" scroll="no" >
    ...
    <div  id="main-container" style="height:auto;overflow: hidden;position:absolute; left:0px;top:90px; bottom:0px;right:0px;">
        <jsp:include page="/pages/comd/comdCenter.jsp"></jsp:include>
    </div>
  </body>
</html>