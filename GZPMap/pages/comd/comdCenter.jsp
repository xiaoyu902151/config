...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/pages/ems/ems_comd.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
		var eventObject;
			$(window).load(function() {
				ems.comd.init(map);
				eventObject=$.parseJSON('${params}');
			    ems.comd.event_Locate(eventObject);
			    ems.comd.creatPlan_select(eventObject.plan_object);
})
			</script>
				...
				<div class="sdrt" style="margin-left: 32px;">
					...
					<ul class="nav nav-sidebar nav-padding">
						<li class="active"><a href="#"><span
								class="icon-location"
								style="color:#1ba1e2;font-size:20px;margin-right:4px;"></span><span>事故点定位</span>
						...
						<li><a href="#"><span class="icon-Annotation"
								style="color:#1ba1e2;font-size:20px"></span><span>疏散方案图</span> </a>
						</li>
						<li><a href="#"><i class="glyphicon glyphicon-phone-alt"
